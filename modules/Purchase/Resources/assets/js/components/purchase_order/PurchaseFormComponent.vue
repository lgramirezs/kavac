            ...
            <div class="col-12 row">
                <div class="col-3">
                    ...
                    <label class="custom-control">
                        <button type="button" data-toggle="tooltip" v-has-tooltip class="btn btn-sm btn-info btn-import" title="Presione para subir el archivo del documento." @click="setFile('acta_inicio')" disabled="">
                            <i class="fa fa-upload"></i>
                        </button>
                        <input type="file" id="acta_inicio" @change="uploadFile('acta_inicio')" style="display:none;">
                ...
                <div class="col-3">
                    ...
                    <label class="custom-control">
                        <button type="button" data-toggle="tooltip" v-has-tooltip class="btn btn-sm btn-info btn-import" title="Presione para subir el archivo del documento." disabled="" @click="setFile('invitation_bussiness')">
                            <i class="fa fa-upload"></i>
                        </button>
                        <input type="file" id="invitation_bussiness" @change="uploadFile('invitation_bussiness')" style="display:none;">
                    ...
                    <div slot="id" slot-scope="props" class="text-center">
                        <div class="feature-list-content-left mr-2" v-if="record.currency">
                            <label class="custom-control custom-checkbox">
                                <p-check class="p-icon p-smooth p-plain p-curve" color="primary-o" :value="'_'+props.row.id" :id="'requirement_check_'+props.row.id" :checked="indexOf(requirement_list, props.row.id, true)" @change="requirementCheck(props.row)">
