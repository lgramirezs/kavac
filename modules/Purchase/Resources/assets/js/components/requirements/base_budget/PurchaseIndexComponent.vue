        ...
        <v-client-table :columns="columns" :data="records" :options="table_options">
            ...
            <div slot="id" slot-scope="props" class="text-center">
                <div class="d-inline-flex">
                    ...
                    <button @click="deleteRecord(props.index,'/purchase/base_budget')" class="btn btn-danger btn-xs btn-icon btn-action" title="Eliminar registro" data-toggle="tooltip" v-has-tooltip type="button">
