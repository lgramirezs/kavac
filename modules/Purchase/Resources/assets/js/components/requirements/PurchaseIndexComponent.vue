        ...
        <v-client-table :columns="columns" :data="records" :options="table_options">
            ...
            <div slot="id" slot-scope="props" class="text-center">
                <div class="d-inline-flex">
                    ...
                    <a class="btn btn-primary btn-xs btn-icon" :href="'/purchase/requirements/pdf/'+props.row.id" title="Imprimir Registro" data-toggle="tooltip" v-has-tooltip target="_blank">
