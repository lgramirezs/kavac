        ...
        <v-client-table :columns="columns" :data="records" :options="table_options">
            ...
            <div slot="id" slot-scope="props" class="text-center">
                <div class="d-inline-flex">
                    ...
                    <purchase-plan-start-diagnosis :id="props.row.id" :route_show="'/purchase/purchase_plans/'+props.row.id" v-if="!props.row.active" />
                    ...
                    <button @click="deleteRecord(props.index,'/purchase/purchase_plans')" class="btn btn-danger btn-xs btn-icon btn-action" title="Eliminar registro" data-toggle="tooltip" v-has-tooltip>
