                ...
                <div class="form-horizontal">
                    <div class="card-body">
                        <div class="row" v-if="has_budget">
                            ...
                            <div class="col-3">
                                <div class="form-group is-required">
                                    ...
                                    <select2 :options="budget_items" :disabled="!specific_action_id" id="budget_item_id" v-model="budget_item_id"></select2>
                                </div>
                            </div>
                            <div class="col-2 text-center">
                                <label class="control-label">Disponibilidad presupuestaria</label><br>
                                <p>
                                    <i class="icofont icofont-ui-check" style="color:#18ce0f" v-show="budget_available >= supplier_price_tot"></i>
                                    <i class="icofont icofont-ui-close" style="color:#FF3636" v-show="budget_available < supplier_price_tot"></i>
                                </p>
                            </div>
                        ...
                        <div class="card-footer text-right" v-if="has_budget">
                            <button class="btn btn-success btn-sm" title="Hay disponibilidad" data-toggle="tooltip" v-has-tooltip :disabled="!budget_item_id || !(budget_available >= supplier_price_tot)" @click="createRecord('/purchase/budgetary_availability')">
                                Hay disponibilidad
                            </button>
                            <button class="btn btn-danger btn-sm" title="No hay disponibilidad" data-toggle="tooltip" v-has-tooltip :disabled="!budget_item_id || !(budget_available < supplier_price_tot)" @click="createRecord('/purchase/budgetary_availability')">
                                No hay disponibilidad
                            </button>
                        </div>
                        <div class="card-footer text-right" v-if="!has_budget">
                            <button class="btn btn-success btn-sm" title="Hay disponibilidad" data-toggle="tooltip" v-has-tooltip @click="createRecord('/purchase/budgetary_availability')">
                                Hay disponibilidad
                            </button>
                            <button class="btn btn-danger btn-sm" title="No hay disponibilidad" data-toggle="tooltip" v-has-tooltip @click="createRecord('/purchase/budgetary_availability')">
                                No hay disponibilidad
                            </button>
                        </div>
                    </div>
