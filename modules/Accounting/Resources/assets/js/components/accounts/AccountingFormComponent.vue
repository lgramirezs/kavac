            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <div class="row inline-inputs">
                            <div class="col-6">
                                <input id="code" type="text" class="form-control input-sm" placeholder="0.0.0.00.00.00.000" data-toggle="tooltip" v-has-tooltip title="Código de la cuenta patrimonial" v-model="record.code">
                            </div>
                        </div>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control input-sm" id="denomination" name="denomination" data-toggle="tooltip" v-has-tooltip placeholder="Descripción de la cuenta" title="Denominación o concepto de la cuenta" v-model="record.denomination">
                    </div>
                </div>
                <div class="col-3">
                    <div class="row">
