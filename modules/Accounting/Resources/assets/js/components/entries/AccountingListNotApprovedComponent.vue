            ...
            <v-client-table :columns="columns" :data="records" :options="table_options" ref="tableMax">
                ...
                <div slot="id" slot-scope="props" class="text-center">
                    <div class="d-inline-flex">
                        ...
                        <accounting-entry-show :modal_name="'show_accounting_unapproved_'" :id="props.row.id" :route_show="app_url+'/accounting/entries/'+props.row.id" />
                        ...
                        <button @click="deleteRecord(props.row.id,'/accounting/entries')" class="btn btn-danger btn-xs btn-icon btn-action" title="Eliminar Registro" data-toggle="tooltip" v-has-tooltip v-if="!props.row.approved">
                            <i class="fa fa-trash-o"></i>
                        </button>
                        <a class="btn btn-primary btn-xs btn-icon" :href="urlPdf+'/pdf/'+props.row.id" title="Imprimir Registro" data-toggle="tooltip" v-has-tooltip target="_blank" v-if="props.row.approved">
