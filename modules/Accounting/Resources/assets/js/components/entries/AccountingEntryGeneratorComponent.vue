            ...
            <div class="row">
                <div class="col-12 col-md-6 form-group" id="helpEntriesCategory">
                    <div class="form-group is-required">
                        ...
                        <select2 :options="categories" v-model="data.category" data-toggle="tooltip" v-has-tooltip title="Categoría del asiento"></select2>
                    </div>
                </div>
                <div class="col-12 col-md-6 form-group" id="helpEntriesDescription">
                    <div class="form-group is-required">
                        <label class="control-label">Concepto ó Descripción</label>
                        <input type="text" class="form-control input-sm" v-model="data.concept" data-toggle="tooltip" v-has-tooltip title="Concepto ó Descripción">
                    </div>
                </div>
            </div>
        </div>
        <table class="table table-formulation">
            ...
            <tbody>
                <tr v-for="(record, index) in recordsAccounting" :key="index">
                    ...
                    <td>
                        <input :disabled="record.assets != 0" type="number" data-toggle="tooltip" v-has-tooltip class="form-control input-sm" :step="cualculateLimitDecimal()" v-model="record.debit" @change="CalculateTot()">
                    </td>
                    <td>
                        <input :disabled="record.debit != 0 " type="number" data-toggle="tooltip" v-has-tooltip class="form-control input-sm" :step="cualculateLimitDecimal()" v-model="record.assets" @change="CalculateTot()">
                    </td>
                    <td>
