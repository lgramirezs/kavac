    ...
    <div>
        ...
        <v-client-table :columns="columns" :data="records" :options="table_options">
            ...
            <div slot="id" slot-scope="props" class="text-center">
                ...
                <button @click="deleteRecord(props.index,'/accounting/entries')" class="btn btn-danger btn-xs btn-icon btn-action" title="Eliminar Registro" data-toggle="tooltip" v-has-tooltip v-if="!props.row.approved">
                    <i class="fa fa-trash-o"></i>
                </button>
                <a class="btn btn-primary btn-xs btn-icon" :href="url+'pdf/'+props.row.id" title="Imprimir Registro" data-toggle="tooltip" v-has-tooltip target="_blank" v-if="props.row.approved">
