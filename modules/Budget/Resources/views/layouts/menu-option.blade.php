...
<li>
    ...
    <ul class="submenu" style="{!! display_submenu('budget') !!}">
        ...
        <li class="{!! set_active_menu(['budget.subspecific-formulations.index', 'budget.subspecific-formulations.create', 'budget.subspecific-formulations.edit']) !!}">
        ...
        <li>
            ...
            <ul class="submenu">
                ...
                <li><a href="{{ route('budget.report.formulated') }}" data-toggle="tooltip"
                        data-placement="right">Presupuesto Formulado</a></li>
            </ul>
        </li>
    </ul>
</li>
