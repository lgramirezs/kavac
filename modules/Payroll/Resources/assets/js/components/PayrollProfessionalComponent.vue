    ...
    <section id="PayroProfessionalForm">
        <div class="card-body">
            ...
            <div class="row" v-for="(payroll_study, index) in record.payroll_studies" :key="index">
                ...
                <div class="col-3" id="helpProfessionalStudyType">
                    <div class="form-group is-required">
                ...
                <div class="col-3" id="helpProfessionalProfession">
                    <div class="form-group is-required">
            ...
            <div class="row" v-for="(payroll_language, index) in record.payroll_languages" :key="index">
                <div class="col-3" id="helpProfessionalLanguage">
                    <div class="form-group is-required">
                        <label>Idioma:</label>
                ...
                <div class="col-3" id="helpProfessionalLanguageLevel">
                    <div class="form-group is-required">
