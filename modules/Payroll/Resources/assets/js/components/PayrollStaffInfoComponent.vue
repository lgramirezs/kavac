                    ...
                    <div class="tab-content">
                        <div class="tab-pane active" id="general" role="tabpanel">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <div class="row" style="margin: 1px 0">
                                            <span class="col-md-12">
                                                {{ record.payroll_blood_type ? record.payroll_blood_type.name : '' }}
                                            </span>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <div class="row" style="margin: 1px 0">
                                            <span class="col-md-12">
                                                {{ record.parish && record.parish.municipality && record.parish.municipality.estate && record.parish.municipality.estate.country ? record.parish.municipality.estate.country.name : '' }}
                                            </span>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <div class="row" style="margin: 1px 0">
                                            <span class="col-md-12">
                                                {{ record.parish && record.parish.municipality && record.parish.municipality.estate ? record.parish.municipality.estate.name : '' }}
                                            </span>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <div class="row" style="margin: 1px 0">
                                            <span class="col-md-12">
                                                {{ record.parish && record.parish.municipality ? record.parish.municipality.name : '' }}
                                            </span>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <div class="row" style="margin: 1px 0">
                                            <span class="col-md-12">
                                                {{ record.parish ? record.parish.name : '' }}
                                            </span>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div>
                                ...
                                <div v-for="uniform_size in record.payroll_staff_uniform_size" class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
