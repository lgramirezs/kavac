<template>
    <div id="PayrollEmploymentInfo" class="modal fade" tabindex="-1" role="dialog"
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <div class="row" style="margin: 1px 0">
                                            <span class="col-md-12">
                                                {{ record.department ? record.department.institution.name : '' }}
                                            </span>
                                        </div>
                                    </div>
                                </div>
